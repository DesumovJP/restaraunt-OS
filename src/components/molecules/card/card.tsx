...
const cardVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      elevation: {
        flat: "shadow-none",
        raised: "shadow-[0_1px_3px_rgba(45,40,35,0.06),0_1px_2px_rgba(45,40,35,0.04)]",
        floating: "shadow-[0_4px_6px_rgba(45,40,35,0.05),0_2px_4px_rgba(45,40,35,0.04)]",
        overlay: "shadow-[0_10px_15px_rgba(45,40,35,0.06),0_4px_6px_rgba(45,40,35,0.04)]",
      },
      // Interactive variant
      interactive: {
        true: [
          ...
          "hover:shadow-[0_4px_6px_rgba(45,40,35,0.05),0_2px_4px_rgba(45,40,35,0.04)]",
          "hover:border-[#D9D1CA]",
          "active:scale-[0.99]",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4A7C4E] focus-visible:ring-offset-2",
        ],
        false: "",
      },
...
>(({ className, as: Comp = "h3", ...props }, ref) => (
  <Comp
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-tight tracking-tight text-[#1A1A1A]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm text-[#666666] leading-normal", className)}
    {...props}
  />
));
  ...
  ({ className, src, alt, aspectRatio = "video", children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative overflow-hidden bg-[#F1EDE9]",
